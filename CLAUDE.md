...
- Inicie o servidor de desenvolvimento: `node serve.mjs` (serve a raiz do projeto em `http://localhost:4009`)
...
- **Sempre tire screenshot a partir do localhost:** `node screenshot.mjs http://localhost:4009`
...
- Sufixo de rótulo opcional: `node screenshot.mjs http://localhost:4009 label` → salva como `screenshot-N-label.png`
